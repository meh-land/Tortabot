...
class StereoCameraStreamer:
    def __init__(self, raw_topic="/image_raw", left_topic="/stereo/left/image_raw", right_topic="/stereo/right/image_raw",
                 ...
                 camera_id=1, frame_width=1280, frame_height=480,
    ...
    def loadCameraInfo(self, yaml_fname):
        package_path = rospkg.RosPack().get_path('ball-selection')
...
if __name__ == "__main__":
    ...
    stereo_streamer = StereoCameraStreamer()
